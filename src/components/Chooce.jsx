...
const Chooce = () => (
  <div className="bg-gray-100 md:p-10 p-4 relative">
     ...
     <h1 className="bg-[#0873ba95] py-2 px-3 rotate-[-10deg] inline-block rounded-lg mb-3"> Why choose us?</h1>
    <h2 className="md:font-bold md:text-4xl text-[20px]">
    Why Choose Expat Global Girls
    </h2>
    <p className="text-gray-400 mt-3 mb-6">Empowering women to travel with confidence and ease worldwide</p>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl mx-auto">
      ...
      >
        <div className="text-left">
          <img src="https://i.ibb.co.com/YhTsw5n/Frame.png" alt="" className="bg-white p-2 mb-2 " />
      ...
      >
        <div className="text-left">
          <img src="https://i.ibb.co.com/q1G1TqH/Frame-37.png" alt="" className="bg-white  mb-2 w-[70px] " />
          <h3 className="text-lg font-semibold text-gray-800 mb-2">
          Flexible Options
          </h3>
          <p className="text-sm text-gray-600">
  ...
  <div className="absulote  left-10 flex justify-center">  <img src="https://i.ibb.co.com/SRVRNZX/imgpsh-fullsize-anim-1.png" alt="" className="lg:block md:block hidden" /></div>
    <div className="grid grid-cols-1 mt-10  md:grid-cols-2 gap-16 max-w-4xl mx-auto">
      ...
      >
        <div className="text-left">
          <img src="https://i.ibb.co.com/qn1K61W/Frame-37-1.png" alt="" className="bg-white w-[60px] mb-2 " />
          <h3 className="text-lg font-semibold text-gray-800 mb-2">
          Verified Profiles
          </h3>
          <p className="text-sm text-gray-600">
      ...
      >
        <div className="text-left">
          <img src="https://i.ibb.co.com/6sNq3Tm/Frame-37-2.png" alt="" className="bg-white  mb-2 w-[60px] " />
          <h3 className="text-lg font-semibold text-gray-800 mb-2">
          Women-Only Spaces
          </h3>
          <p className="text-sm text-gray-600">
